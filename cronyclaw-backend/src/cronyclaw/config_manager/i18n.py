...
class MultiLingualString(BaseModel):
    ...
    vi: str = Field(default="", description="Vietnamese translation")
...
class Description(MultiLingualString):
    ...
    def from_str(cls, text: str, notes: str | None = None) -> "Description":
        ...
        return cls(
            ...
            zh=text,
            vi=text,
            notes=MultiLingualString(en=notes, zh=notes, vi=notes) if notes else None,
        )
