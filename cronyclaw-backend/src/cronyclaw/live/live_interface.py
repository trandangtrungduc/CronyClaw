...
class LivePlatformInterface(ABC):
    ...
    It handles connecting to the CronyClaw server via proxy, sending messages from the live platform,
    ...
    async def connect(self, proxy_url: str) -> bool:
        """
        Connect to the CronyClaw server via proxy WebSocket.
    ...
    async def send_message(self, text: str) -> bool:
        """
        Send a message from the live platform to CronyClaw.
    ...
    async def register_message_handler(
        ...
        """
        Register a callback function to handle response messages from CronyClaw.
    ...
    async def handle_incoming_messages(self, message: Dict[str, Any]) -> None:
        """
        Process incoming messages from the CronyClaw server.
