...
function About(): JSX.Element {
  ...
  // const appAuthor = 'CronyClaw Team';
  ...
  return (
    <Stack {...settingStyles.common.container} gap={3}>
      ...
      <Box mt={1}>
        ...
        <HStack mt={1} gap={2}>
          <Button
            ...
            onClick={() =>
              openExternalLink(
                "https://github.com/trandangtrungduc/CronyClaw"
              )
            }
          >
          ...
          <Button
            size="sm"
            onClick={() => openExternalLink("https://github.com/trandangtrungduc/CronyClaw")}
          >
      ...
      <Box borderTop="1px solid" borderColor="whiteAlpha.200" pt={2} mt={1} />
      <Box mt={1}>
        <Button size="xs" colorPalette="blue" onClick={() => openExternalLink("https://github.com/trandangtrungduc/CronyClaw")}>
      ...
      <Box mt={1}>
        ...
        <Text>© {new Date().getFullYear()} CronyClaw Team</Text>
      </Box>
    </Stack>
  );
}
