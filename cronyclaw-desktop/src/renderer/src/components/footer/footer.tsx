...
import { SlashCommandUi, type SlashAssistUi } from '@/components/ui/slash-command-ui';
  ...
  return (
    <InputGroup flex={1}>
      <Box position="relative" width="100%">
        <SlashCommandUi assist={slashAssist} />
        <IconButton
